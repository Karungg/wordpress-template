...
<p class="has-text-align-center"><?php echo __('his is the Content block, it will display all the blocks in any single post or page.', 'savora');?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--70)"><!-- wp:post-featured-image /-->
